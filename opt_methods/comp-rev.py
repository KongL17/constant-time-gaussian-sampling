...
pre = permutations(n)
#print(pre, len(pre))
f = open(r"C:\Users\sony\Desktop\opt_method\subtree.txt", 'r')
p = []
p_head = []
p_tial = []
for i in range(4):
...
for i in pre:
    f = open(r"C:\Users\sony\Desktop\opt_method\cache.txt", 'w')
    for k in p_head:
        f.write(k)
    mm = 0
    for j in i:
    ...
    for m in p_tial:
        f.write(m)
    f.close()
    os.system(r"C:\Users\sony\Desktop\opt_method\espresso.exe -Dso -S1 -o eqntott C:\Users\sony\Desktop\opt_method\cache.txt > C:\Users\sony\Desktop\opt_method\cache.out")
    time.sleep(0.1)
    count = count_logic(r"C:\Users\sony\Desktop\opt_method\cache.out")
    print(count)
    #f1.write(str(count)+'\n')
    if count <= max[1]:
        max[0] = i.copy()
...
s_r = " "
f2 = open(r"C:\Users\sony\Desktop\opt_method\subtree.txt", 'r')
for i in range(4):
    s_r += f2.readline()
s = []
for i in range(n):
...
s_r += ".e"
f3 = open(r"C:\Users\sony\Desktop\opt_method\subtree.txt", 'w')
f3.write(s_r)
f3.close()
