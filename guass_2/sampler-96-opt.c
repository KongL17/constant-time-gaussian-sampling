...
int main(){
	...
	for(i=0;i<repeat;i++){	
		...
		out[4] = (control & ((~bit[93]&bit[92]&(bit[89] | ~bit[91]&bit[90])) | ((~bit[90] | bit[95]&~bit[94])&~bit[93]&bit[91]&bit[89]) | (bit[93]&~bit[92]&bit[91]&bit[90]&~bit[89])))  | (~control & out[4]);
		out[3] = (control & (((bit[95] | bit[94] | ~bit[89])&bit[93]&bit[92]&bit[90]) | ((bit[93]&~bit[90] | ~bit[95]&~bit[93]&bit[90])&bit[91]&bit[89])))  | (~control & out[3]);
		out[2] = (control & ((bit[91]&~bit[89]) | (~bit[94]&bit[92]&bit[91]) | (bit[95]&bit[92]&bit[90]&bit[89]) | ((~bit[92]&~bit[90] | ~bit[94]&bit[90])&~bit[91]&bit[89])))  | (~control & out[2]);
		out[1] = (control & ((~bit[93]&~bit[92]&(~bit[91] | bit[95]&~bit[94]&bit[90])) | ((~bit[93]&bit[92] | bit[94]&bit[91])&~bit[90]&bit[89]) | ((~(bit[95] | bit[94])&bit[92] | bit[94]&bit[93]&~bit[91])&bit[90]&bit[89]) | (~bit[92]&~bit[89])))  | (~control & out[1]);
		out[0] = (control & (((bit[92] | ~bit[93]&bit[89])&~bit[91]&~bit[90]) | ((~bit[93] | ~bit[90])&bit[92]&~bit[89]) | ((~bit[92] | bit[95]&bit[89])&bit[93]&~bit[91]&bit[90]) | ((bit[95]&bit[94]&bit[92] | ~bit[94]&~bit[93]&~bit[92])&bit[90]&bit[89]) | ((~bit[94]&bit[93] | bit[94]&~bit[92])&bit[91]&~bit[90]&bit[89])))  | (~control & out[0]);
...
//-----------------------------------------------------------------------------------------------------
		...
		if(control==0xffffffffffffffff)//even if the sample is not found within depth 96
			break;
	}
